...
export PATH=MiniZincIDE-"$version"-bundle-linux-x86_64/bin:$PATH
export LD_LIBRARY_PATH=MiniZincIDE-"$version"-bundle-linux-x86_64/lib:$LD_LIBRARY_PATH
export QT_PLUGIN_PATH=MiniZincIDE-"$version"-bundle-linux-x86_64/plugins:$QT_PLUGIN_PATH
